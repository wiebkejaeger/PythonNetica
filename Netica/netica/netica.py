...
$Id: netica.py 10405 2014-03-17 10:39:11Z heijer $
$Date: 2014-03-17 11:39:11 +0100 (Mon, 17 Mar 2014) $
$Author: heijer $
$Revision: 10405 $
...
#        self.ln = cdll.LoadLibrary("/Users/heijer/Downloads/Netica_API_504/lib/libnetica.so")
    ...
    def enternodelikelyhood(self, node_p, prob_bn):
        ...
        self.ln.EnterNodeLikelihood_bn.argtypes = [c_void_p, ndpointer('float32', ndim=1, shape=(nstates,),flags='C')] # (node_bn* node, const prob_bn* likelihood)
    ...
    def getnodebeliefs(self, node_p):
        ...
        self.ln.GetNodeBeliefs_bn.restype = ndpointer('float32', ndim=1, shape=(nstates,),flags='C')
    ...
    def setnodelevels(self, node_p, num_states, levels):
        ...
        self.ln.SetNodeLevels_bn.argtypes = [c_void_p, c_int, ndpointer('double', ndim=1, shape=(len(levels),),flags='C')]
